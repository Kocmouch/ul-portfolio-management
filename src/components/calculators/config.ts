...
export const calculatorsConfig: CalculatorMeta[] = [
  ...
  },
  {
    ...
    description:
      'Correlation standardizes covariance and ranges from -1 to 1, indicating the strength and direction of linear relationships.',
  ...
  },
  {
    ...
    description:
      'Arithmetic average is the unweighted mean of periodic returns; useful for short-term forecasts but ignores compounding.',
  ...
  },
  {
    ...
    description:
      'Given discrete states with probabilities and returns, compute the expected return, variance and standard deviation.',
